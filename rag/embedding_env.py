...
def main():
    ...
    if not MONGO_URI:
        print("❌ ไม่พบ MONGODB_URI ในไฟล์ .env กรุณาตรวจสอบให้แน่ใจว่าสร้างไฟล์และตั้งค่าตัวแปรถูกต้อง")
        return

    # ==========================================
    # 2. ตั้งค่าการเชื่อมต่อ MongoDB Atlas
    # ==========================================
    try:
    ...
    # ==========================================
    # 3. โหลดโมเดล BAAI/bge-m3
    # ==========================================
    print("กำลังโหลดโมเดล BAAI/bge-m3 (อาจใช้เวลาสักครู่)...")
    model = SentenceTransformer('BAAI/bge-m3')

    # ==========================================
    # 4. ดึงข้อมูลที่ยังไม่มี 'embedding' มาประมวลผล
    # ==========================================
    ...
    # ==========================================
    # 5. เริ่มกระบวนการทำ Embedding และเตรียม Update แบบ Bulk
    # ==========================================
